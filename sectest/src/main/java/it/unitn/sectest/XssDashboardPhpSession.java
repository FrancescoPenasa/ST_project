...
public class XssDashboardPhpSession extends BaseTest {

	
	//DONE
	@Test
	public void testXssDashboardPhpSession() {
		...
		WebElement dashboardUsernameSpan = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/a[1]/span[1]"));
